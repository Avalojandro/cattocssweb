<template>
  <div>
    <div
      class="text-white grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 pb-32"
    >
      <div
        v-for="animation of animations"
        :key="animation"
        class="p-10 text-center items-center"
      >
        <div
...
.hinge:hover {
  ...
  methods: {
    getAnimation(animationClass) {
      const className =
        "p-5 cursor-pointer bg-transparent border border-primary-catto bg-primary-catto text-white font-bold rounded wrp";
